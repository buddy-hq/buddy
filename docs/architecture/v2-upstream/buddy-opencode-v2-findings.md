...
| [vendor-codex-prompt-pipelines.md](../../research/context-engineering/buddy-prompt-engineering/vendor-codex-prompt-pipelines.md) | Prompt layering pain (v2 `Prompt` may help when prompt ships) |
