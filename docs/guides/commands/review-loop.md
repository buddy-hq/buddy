...
- review the code changes with verbatim instructions from: `docs/guides/commands/review.md`
  - patch the findings.
...
1. dispatch a subagent with 
  1. exact instrucions in `docs/guides/commands/review.md`
...
### MODE 2: Self-ONLY
1. review the code changes with verbatim instructions from: `docs/guides/commands/review.md`
