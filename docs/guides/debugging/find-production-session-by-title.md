...
bun packages/buddy/script/export-session-trace.ts \
  --channel prod \
  --title "120021" \
  --output docs/features/error-handling/session-120021.trace.json
```
...
bun packages/buddy/script/export-session-trace.ts \
  --channel prod \
  --session-id "ses_..." \
  --output docs/features/error-handling/session.trace.json
```
...
bun packages/buddy/script/export-session-trace.ts \
  --channel dev \
  --title "Session title" \
  --output docs/features/error-handling/dev-session.trace.json
```
