...
This document is retained for historical context. The canonical Electron-only release process is now in [`docs/ops/releases/cut-release-electron.v2.algo.md`](/Users/prashantbhudwal/Code/buddy/docs/ops/releases/cut-release-electron.v2.algo.md).
