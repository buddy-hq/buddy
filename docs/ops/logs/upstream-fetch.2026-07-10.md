...
The dated findings in `docs/architecture/v2-upstream/` are inputs, not source of truth. Every claim will be rechecked against the selected upstream snapshot.
...
- Restored `docs/architecture/v2-upstream/upstream-v2-audit-2026-07-04.md` from the newest stash into the real worktree. Its dated findings remain research history; this current source audit supersedes its branch-tip hashes.
