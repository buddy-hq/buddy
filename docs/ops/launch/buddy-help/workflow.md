...
| Deliverable | Path |
| --- | --- |
| Grounding research (internal; not shipped) | `docs/ops/launch/buddy-help/pilot-archive/research/<name>.research.md` |
| Skill reference body (ships with skill) | `docs/ops/launch/buddy-help/skill/references/<name>.md` |
...
| Read must-read docs below | Open `docs/ops/launch/buddy-help/pilot-archive/**` |
...
| File | Why |
| --- | --- |
| `docs/ops/launch/buddy-help/workflow.md` | This contract |
| `docs/ops/launch/buddy-help/research.md` | Ontology, dual-language, **your** term-audit row, honesty pitfalls |
| `docs/ops/launch/buddy-help/skill/SKILL.md` | Router rules, dual phrases, defaults, answer shape |
| `docs/ops/launch/buddy-help/skill/references/<name>.md` | Your stub only |
...
Path: `docs/ops/launch/buddy-help/pilot-archive/research/<name>.research.md`
...
Read **in full:** `docs/ops/launch/buddy-help/skill-style-guide.md` (especially §5–§5d).
