...
- The audit docs in `docs/archive/tauri-opencode-parity-audit.md` and `docs/product/opencode-sdk-replacement-audit.md` were refreshed to match the new boundary layout.
