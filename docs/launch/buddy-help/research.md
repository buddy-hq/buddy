...
**Launch home:** `docs/launch/critical-path.md` → About Buddy Skill.
...
| Path | Role |
| --- | --- |
| `docs/launch/buddy-help/research.md` | **This file** — plan, tree, term audit |
| `docs/launch/buddy-help/skill-style-guide.md` | Writing craft for skills (separate on purpose) |
