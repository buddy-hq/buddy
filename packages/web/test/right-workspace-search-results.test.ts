...
import { notebookSearchResultFromWorkspaceObject } from "../src/components/directory-chat/right-workspace-search-results"
...
describe("right workspace search results", () => {
