    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <motion.button
          ...
          whileHover={{ y: -4, scale: 1.1, boxShadow: "0 0 20px var(--surface-interactive-base)" }}
          whileTap={{ scale: 0.9 }}
          ...
          className="relative flex size-10 cursor-grab items-center justify-center rounded-full bg-surface-interactive-base text-text-on-interactive-base shadow-xl shadow-surface-interactive-base/20 ring-4 ring-background-base transition-shadow active:cursor-grabbing"
