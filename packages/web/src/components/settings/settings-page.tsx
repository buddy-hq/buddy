  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 flex-col">
      ...
      {props.activeTab === "notebook" && (
        <NotebookSettings directory={props.directory} />
      )}
      {props.activeTab === "model" && (
        <ModelSettings directory={props.directory} />
      )}
      {props.activeTab === "providers" && (
        <ProvidersSettings directory={props.directory} />
      )}
      {props.activeTab === "mcps" && (
        <McpsSettings directory={props.directory} />
      )}
    </div>
  );
}
