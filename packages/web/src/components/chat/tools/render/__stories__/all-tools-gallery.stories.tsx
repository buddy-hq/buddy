  ...
  return [
    {
      ...
      cards: [
        ...
        card(
          ...
          { title: t("chatTools.info.read"), subtitle: "src/components/App.tsx" },
        ),
        card(
          "read",
          renderReadTool,
    ...
    },
    {
      ...
      cards: [
        ...
        card(
          ...
          { title: t("chatTools.info.shell"), subtitle: "npm run test" },
        ),
        card(
          "bash",
          renderBashTool,
    ...
    },
    {
      ...
      cards: [
        ...
        card(
          ...
          { title: t("chatTools.info.websearch"), subtitle: "React best practices" },
        ),
        card(
          "webfetch",
          renderWebfetchTool,
        ...
        card(
          ...
          { title: t("chatTools.info.webfetch"), subtitle: "example.com/api/data" },
        ),
        card(
          "webfetch",
          renderWebfetchTool,
        ...
        card(
          ...
          { title: t("chatTools.info.codesearch"), subtitle: "TypeScript 5.5 features" },
        ),
      ],
    },
    {
      ...
      cards: [
        ...
        card(
          ...
          { title: t("chatTools.info.skill"), subtitle: "frontend-design" },
        ),
        card(
          "skill",
          renderSkillTool,
