...
export function skillLibraryAction(state: SkillLibraryEntry["state"]): SkillLibraryAction {
...
export function skillLibraryButtonVariant(action: SkillLibraryAction): SkillLibraryButtonVariant {
