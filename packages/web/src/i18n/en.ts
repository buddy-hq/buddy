export const dict = {
  ...
  "settings.updates.statusChecking": "Checking for updates",
  "settings.updates.statusDescription": "Current updater activity on this device.",
  "settings.updates.statusDownloading": "Downloading update",
  "settings.updates.statusError": "Update check failed",
  "settings.updates.statusIdle": "No update activity",
  "settings.updates.statusInstalling": "Installing and restarting",
  "settings.updates.statusReady": "Update ready to install",
  "settings.updates.statusReadyWithVersion": "Buddy {{version}} is ready to install",
  "settings.updates.statusTitle": "Status",
