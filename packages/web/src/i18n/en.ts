export const dict = {
  ...
  "notes.action.add": "Quote in note",
  "notes.action.new": "New note",
  "notes.action.open": "Open",
  "notes.action.save": "Save note",
  "notes.action.tryAgain": "Try again",
  "notes.annotation.description": "The message will be quoted in this chat’s note.",
  "notes.annotation.placeholder": "What do you want to remember?",
  "notes.annotation.saveFailed": "Annotation could not be saved.",
  "notes.composer.attachmentsUnsupported":
    "Only images can be saved in a note. Remove other attachments first.",
  "notes.composer.attachImages": "Attach images",
  "notes.composer.imageFilenameTooLong": "Image filenames must be 255 characters or fewer.",
  "notes.composer.imageInvalid": "This image could not be prepared for saving.",
  "notes.composer.imageTooLarge": "Each note image must be 20 MB or smaller.",
  "notes.composer.tooManyImages": "You can save up to 10 images in a note.",
  "notes.composer.mode": "Note",
  "notes.composer.placeholder": "Write a note…",
  "notes.composer.returnToChat": "Return to chat",
  "notes.composer.save": "Save",
  "notes.composer.saveFailed": "Note could not be saved.",
  "notes.composer.takeNote": "Take a note",
  "notes.createFailed": "Note could not be created.",
  "notes.empty.description": "Create a note or capture one from chat.",
  "notes.empty.noMatches": "No matching notes",
  "notes.empty.noNotes": "No notes yet",
  "notes.empty.searchAgain": "Try another search.",
  "notes.library.all": "All notes",
  "notes.library.loadFailed": "Notes could not be loaded.",
  "notes.library.missingNotebook": "Notebook not open · {{date}}",
  "notes.library.search": "Search notes…",
  "notes.library.thisNotebook": "This notebook",
  "notes.library.title": "Notes",
  "notes.section.fromChats": "Chat notes",
  "notes.section.standalone": "My notes",
  "notes.session.prepareFailed": "A chat could not be prepared for this note.",
  "notes.toast.saved": "Note saved",
  "notes.toast.savedTo": "Saved to {{name}}",
  "notes.toast.deleted": "Deleted {{name}}",
  "notes.action.delete": "Delete note",
  "notes.action.undo": "Undo",
  "notes.delete.failed": "The note could not be deleted.",
  "notes.action.openChat": "Open chat",
  "notes.action.openNote": "Open note",
  "notes.chat.unavailable": "The original chat is unavailable.",
  "notes.empty.inNotebook": "No notes in this notebook",
  "notes.library.showAll": "Show all notes",
  "notes.unavailable.description": "This note could not be loaded.",
  "notes.unavailable.title": "Note unavailable",
  ...
  "objectPresentation.kind.note": "Note",
  ...
  "prompt.slash.note.description": "Write a note instead of a message.",
  "prompt.slash.note.title": "Take a note",
  ...
  "routes.settings.nav.shortcuts": "Shortcuts",
  ...
  "settings.appearance.chatFontAria": "Chat font family",
  "settings.appearance.chatFontSizeAria": "Chat font size",
  "settings.appearance.chatLineHeightAria": "Chat line height",
  "settings.appearance.chatLineSpacingCompactOption": "Compact",
  "settings.appearance.chatLineSpacingCustomOption": "Custom",
  "settings.appearance.chatLineSpacingNormalOption": "Normal",
  "settings.appearance.chatLineSpacingRelaxedOption": "Relaxed",
  "settings.appearance.chatSection": "Chat",
  "settings.appearance.codeFontAria": "Code font family",
  "settings.appearance.codeFontSizeAria": "Code font size",
  "settings.appearance.codeSection": "Code",
  "settings.appearance.colorsSection": "Colors",
  ...
  "settings.appearance.customFontSizeAria": "Custom {{label}}",
  "settings.appearance.customFontSizeTitle": "Custom size",
  "settings.appearance.documentFontAria": "Document font family",
  ...
  "settings.appearance.fontSizeOption": "{{size}} px",
  "settings.appearance.fontSizeTitle": "Font size",
  "settings.appearance.fontTitle": "Font",
  "settings.appearance.interfaceSection": "Interface",
  "settings.appearance.lineHeightTitle": "Line height",
  "settings.appearance.lineSpacingTitle": "Line spacing",
  "settings.appearance.themePlaceholder": "Select theme",
  "settings.appearance.themeTitle": "Theme",
  "settings.appearance.uiFontAria": "UI font family",
  "settings.appearance.uiFontSizeAria": "UI font size",
  ...
  "settings.updates.checkDescription":
    "Looks for a newer release in your channel. Nothing downloads until you choose to.",
  ...
  "updates.action.install": "Restart to install",
  "updates.action.retry": "Try again",
  "updates.button.install": "Install",
  "updates.confirm.action": "Restart now",
  "updates.confirm.description":
    "Buddy will close and reopen. Anything running right now, including chats that are still replying, will be stopped.",
  "updates.confirm.title": "Restart to install Buddy {{version}}?",
  "updates.failure.check": "Couldn't check for updates",
  "updates.failure.detail": "Buddy is still running this version.",
  "updates.failure.download": "Couldn't download the update",
  "updates.failure.install": "Couldn't install the update",
  "updates.hint.download": "Click to download",
  "updates.hint.install": "Click to restart and install",
  "updates.hint.retry": "Click to try again",
  "updates.releaseNotes.moreChanges": "{{count}} more changes",
  "updates.releaseNotes.moreChangesOne": "1 more change",
  "updates.releaseNotes.title": "What's new",
  "updates.releaseNotes.versionTitle": "In {{version}}",
  "updates.releaseNotes.viewRelease": "Full release notes",
  "updates.status.available": "Buddy {{version}} is available",
  "updates.status.blocked": "The latest release is on hold. Updates will resume on their own.",
  "updates.status.checking": "Checking for updates…",
  "updates.status.downloaded": "Buddy {{version}} is ready to install",
  "updates.status.downloading": "Downloading Buddy {{version}}",
  "updates.status.downloadingPercent": "Downloading Buddy {{version}} · {{percent}}%",
  ...
  "settings.general.notesDirectoryTitle": "Notes library",
  "settings.general.notesDirectoryDescription":
    "Central folder for Markdown notes. Changing it does not move files.",
  "settings.general.notesDirectoryChange": "Choose folder…",
  "settings.general.notesDirectoryReset": "Reset to default",
  ...
  "settings.shortcuts.benchSection": "Bench",
  "settings.shortcuts.chatByPosition": "Jump to chat 1–9",
  "settings.shortcuts.chatsSection": "Chats",
  "settings.shortcuts.composerSection": "Composer",
  "settings.shortcuts.description":
    "These are Buddy's built-in shortcuts. Customization isn't available yet.",
  "settings.shortcuts.focusComposer": "Focus chat input",
  "settings.shortcuts.keyRange": "{{first}} through {{last}}",
  "settings.shortcuts.keysAria": "{{action}}: {{keys}}",
  "settings.shortcuts.navigationSection": "Navigation",
  "settings.shortcuts.newBrowserTab": "New tab",
  "settings.shortcuts.newChat": "New chat",
  "settings.shortcuts.nextChat": "Next chat",
  "settings.shortcuts.previousChat": "Previous chat",
  "settings.shortcuts.searchNotebook": "Search notebook",
  "settings.shortcuts.toggleBench": "Toggle Bench",
  "settings.shortcuts.toggleNoteMode": "Toggle Note mode",
  "settings.shortcuts.toggleNoteModeDescription": "Works while the chat composer is focused.",
  "settings.shortcuts.toggleSidebar": "Toggle sidebar",
  "settings.shortcuts.webDescription":
    "These are Buddy's built-in shortcuts. Some may be handled by your browser, and customization isn't available yet.",
  ...
  "settings.providers.accountEmailLoading": "Loading account email…",
  "settings.providers.accountEmailUnavailable": "Account email unavailable",
  "settings.providers.blurAccountEmail": "Blur ChatGPT account email",
  "settings.providers.showAccountEmail": "Show ChatGPT account email",
