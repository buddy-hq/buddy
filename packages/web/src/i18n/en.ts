export const dict = {
  ...
  "rightSidebar.unavailable.editor": "Teaching editor is not available for this session.",
  ...
  "settings.providers.description":
    "Connect provider accounts and choose which connected provider is used for model selection. Changes save automatically.",
