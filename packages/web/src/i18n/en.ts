export const dict = {
  ...
  "chat.permissionDock.toolHint.edit": "Edit sections of files.",
  "chat.permissionDock.toolHint.glob": "Search files by glob pattern.",
  "chat.permissionDock.toolHint.grep": "Search file contents by pattern.",
  "chat.permissionDock.toolHint.list": "List files and directories.",
  "chat.permissionDock.toolHint.read": "Read files from your notebook.",
  "chat.permissionDock.toolHint.task": "Delegate work to a sub-agent.",
  "chat.permissionDock.toolHint.webfetch": "Fetch content from URLs.",
  "chat.permissionDock.toolHint.write": "Write or replace files in your notebook.",
  ...
  "chatTools.defaultMermaidAlt": "Mermaid diagram",
  "chatTools.defaultMermaidType": "mermaid",
  ...
  "chatTools.info.glob": "Glob",
  "chatTools.info.grep": "Grep",
  "chatTools.info.list": "List",
  "chatTools.info.mermaid": "Mermaid",
  "chatTools.info.patch": "Patch",
  "chatTools.info.pythonCalculator": "Python calculator",
  "chatTools.info.questions": "Questions",
  "chatTools.info.read": "Read",
  "chatTools.info.shell": "Shell",
  "chatTools.info.skill": "Skill",
  "chatTools.info.webfetch": "Webfetch",
  "chatTools.info.websearch": "Websearch",
  "chatTools.info.write": "Write",
  "chatTools.loadedPrefix": "Loaded",
  "chatTools.mermaidArtifactMissingFields": "Mermaid artifact payload is missing required fields.",
  ...
  "chatTools.mermaidDiagram.zoomLevelAria": "Mermaid zoom level",
  ...
  "chatTools.rehydratingMermaid": "Rehydrating Mermaid source from durable artifact...",
  "chatTools.renderedAutomatically": "rendered automatically from tool output",
  "chatTools.renderMermaidError": "Unable to render mermaid diagram",
  ...
  "debug.systemPrompt.description": "Exact system prompt from the most recent outbound LLM turn.",
  ...
  "debug.systemPrompt.title": "System Prompt",
  ...
  "mcp.editorDialog.addTitle": "Add MCP",
  ...
  "rightSidebar.tabs.agents": "Agents",
  ...
  "rightSidebar.unavailable.agentsMd": "AGENTS.md editing is not available for this notebook.",
  ...
  "settings.advanced.externalSkillsDescription":
    "When enabled for this notebook, Buddy discovers vendor-style skills from home and ancestor directories.",
  ...
  "settings.instructions.description":
    "Manage global AGENTS.md instructions that apply to every notebook session.",
  ...
  "settings.notebook.fullTextDescription":
    "Allow Buddy to ingest an entire prepared resource into context when there is enough live context budget. Turn this off to avoid expensive full-book reads.",
  "settings.notebook.fullTextTitle": "Whole-book full-text reading",
  ...
  "skills.actionsMenu": "Permissions",
  "skills.add": "Add",
  ...
  "teaching.editor.diagnosticsTitle": "LSP Diagnostics",
  ...
  "teaching.editor.noLsp": "No LSP server is available for the active teaching file.",
