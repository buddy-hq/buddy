export const dict = {
  ...
  "notes.library.missingNotebook": "Missing notebook · {{date}}",
  "notes.library.search": "Search notes…",
  "notes.library.thisNotebook": "This notebook",
  "notes.library.title": "Notes",
  "notes.section.fromChats": "From chats",
  "notes.section.standalone": "Standalone",
  ...
  "settings.general.notesDirectoryChange": "Change Notes",
