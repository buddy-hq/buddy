export const dict = {
  ...
  "chat.sessionContextUsage.planUsageLimits": "Plan usage limits",
  "chat.sessionContextUsage.refreshLimits": "Refresh usage limits",
  "chat.sessionContextUsage.loadingLimits": "Loading usage limits…",
  "chat.sessionContextUsage.limitsUnavailable": "Usage information is unavailable right now.",
  "chat.sessionContextUsage.reconnect": "Reconnect ChatGPT in settings to see limits.",
  "chat.sessionContextUsage.resets": "Resets {{time}}",
  "chat.sessionContextUsage.updated": "Updated {{time}}",
  ...
  "chat.sessionContextUsage.percentUsed": "{{percent}}% used",
  ...
  "obsidian.connectionDialog.description":
    '"{{name}}" is an Obsidian vault. Connect it so Buddy understands your links, embeds, and callouts.',
  ...
  "settings.providers.chatGptReconnectDescription":
    "Your ChatGPT connection is no longer valid. Reconnect it to continue.",
  "settings.providers.chatGptReconnectRequired": "Reconnect required",
  "settings.providers.chatGptUsageError": "Usage information is unavailable right now.",
