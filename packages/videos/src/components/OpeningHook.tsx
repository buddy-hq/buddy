...
import { LOGO_TRANSITION_DURATION_FRAMES, LogoTransition } from "./LogoTransition"
import { FeynmanCaptions } from "./FeynmanCaptions"
import { TELEVISION_FADE_OUT_START_FRAME, TELEVISION_TOTAL_FRAMES, Television } from "./Television"
...
export const OpeningHook = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#09090b" }}>
      <Sequence durationInFrames={TELEVISION_TOTAL_FRAMES} from={OPENING_START_FRAME}>
        <AbsoluteFill
          style={{
            alignItems: "center",
