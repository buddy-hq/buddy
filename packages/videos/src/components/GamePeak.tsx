...
export const GAME_CLIP_DURATION_FRAMES = Math.round(
  GAME_CLIP_DURATION_SECONDS * BUDDY_LAUNCH_FPS,
)
const GAME_FADE_OUT_START_FRAME =
  GAME_CLIP_DURATION_FRAMES - GAME_FADE_OUT_DURATION_FRAMES
