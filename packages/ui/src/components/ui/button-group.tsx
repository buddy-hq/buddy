...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "bg-surface-weak border-border-base gap-2 rounded-lg border px-2.5 text-sm font-medium [&_svg:not([class*='size-'])]:size-4 flex items-center [&_svg]:pointer-events-none",
        className,
      )}
      {...props}
    />
...
function ButtonGroupSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "bg-border-base relative self-stretch data-horizontal:mx-px data-horizontal:w-auto data-vertical:my-px data-vertical:h-auto",
        className,
      )}
      {...props}
    />
