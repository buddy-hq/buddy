...
- Answer users in **UI nouns** (Settings, notebook, thread, Sources, Bench) for product questions.
...
- Never tell yourself to “open the question dock” or “use the composer tool.” Thread (sidebar) ≈ session. Notebook (UI) ≈ workspace folder.
...
| Notebooks, Home, Inbox, Quick Chat, threads, pin/archive, branch, compact | `references/notebooks.md` |
