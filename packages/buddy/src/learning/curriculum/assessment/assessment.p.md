...
5. Once the learner's performance is known, explain the outcome clearly; inferred memory generation is handled by the background learner-memory extractor.
6. Return either:
