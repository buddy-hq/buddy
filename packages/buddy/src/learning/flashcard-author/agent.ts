...
export const FLASHCARD_AUTHOR_AGENT = defineBuddySubagent({
  ...
  description:
    "Generates structured flashcard decks (basic and cloze), persists them, and when the delegated task names resources it should ingest their prepared full text before authoring cards.",
