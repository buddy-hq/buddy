...
const catalog = {
  ...
  glob: defineToolPresentation({
    ...
    layoutRole: "activity",
    phases: {
      pending: { action: "Finding files", detail: inputString("pattern") },
      running: { action: "Finding files", detail: inputString("pattern") },
      completed: { action: "Found files", detail: inputString("pattern") },
      error: { action: "Failed to find files", detail: inputString("pattern") },
    },
    summary: {
  ...
  grep: defineToolPresentation({
    ...
    layoutRole: "activity",
    phases: {
      pending: { action: "Searching", detail: inputString("pattern") },
      running: { action: "Searching", detail: inputString("pattern") },
      completed: { action: "Searched", detail: inputString("pattern") },
      error: { action: "Failed to search", detail: inputString("pattern") },
    },
    summary: {
  ...
  webfetch: defineToolPresentation({
    ...
    layoutRole: "activity",
    phases: {
      pending: { action: "Reading web page", detail: inputString("url") },
      running: { action: "Reading web page", detail: inputString("url") },
      completed: { action: "Read web page", detail: inputString("url") },
      error: { action: "Failed to read web page", detail: inputString("url") },
    },
    summary: {
      category: "fetch-pages",
      pending: "Reading web page",
  ...
  skill: defineToolPresentation({
    ...
    layoutRole: "activity",
    phases: {
      pending: { action: "Using skill", detail: inputString("name") },
      running: { action: "Using skill", detail: inputString("name") },
      completed: { action: "Used skill", detail: inputString("name") },
      error: { action: "Failed to use skill", detail: inputString("name") },
    },
    summary: {
      category: "load-skills",
      pending: "Using skills",
      running: "Using skills",
      completed: "Used skills",
      error: "Failed to use skills",
    },
  }),
  apply_patch: defineToolPresentation({
    ...
    layoutRole: "activity",
    phases: {
      pending: { action: "Editing", detail: patchFileDetail },
      running: { action: "Editing", detail: patchFileDetail },
      completed: { action: "Edited", detail: patchFileDetail },
      error: { action: "Failed to edit", detail: patchFileDetail },
    },
    summary: {
      category: "edit-files",
      pending: "Editing files",
